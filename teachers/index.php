<?php
    ...
    $path = str_replace("/teachers", "", $request_uri); 
...
<html>
    ...
    <body>
        <main class="container mt-4">
            ...
            <?php if (!$is_logged_in): ?>
                <a href="/teachers/register" class="btn btn-outline-primary mr-2">Register</a>
                <a href="/teachers/login" class="btn btn-success">Login</a>
            <?php else: ?>
                <span class="mr-3">Logged in as: <b><?= htmlspecialchars($_SESSION['user_email'] ?? 'User') ?></b></span>
                <a href="/teachers/" class="btn btn-outline-secondary">View Users</a>
                <a href="/teachers/logout" class="btn btn-danger">Logout</a>
            <?php endif; ?>
