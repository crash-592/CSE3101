...
class Database {
    ...
    private function seed() {
        ...
        // Updated SQL to include grade and class
        $sql = "INSERT INTO account(first_name, last_name, email, passcode, role, grade, class) 
                VALUES (:fName, :lName, :email, :passcode, 'superuser', :grade, :class)";
